...
void task_conversion(void* p_params)
{
    ...
    for(;;)
    {
        ...
        */
        ...
        // int16_t enc_feedback_thetam1 = 0;
        // int16_t enc_feedback_thetam2 = 0;
        ...
        // float duty1 = 0.0853*controlled_thetam_d1;
        // //Serial.print("Duty Cycle [%]:  ");
        
        // float duty2 = 0.0136*controlled_thetam_d2;
        int duty1[] = {70, 75, 80, 85};
        int size = 6;
        int index=0;
        while (index<size)
        {
                mot_obj1.set_duty2(duty1[index]);
                Serial.println(duty1[index]);
                delay(3000);
